...
public class ClientEventHandler implements CMAppEventHandler{
	...
	private int m_nTotalClient;
	public ClientEventHandler(CMClientStub clientStub, UserGUI client)
	{
		m_client = client;
	...
	private void processInterestEvent(CMEvent cme)
	{
		...
		case CMInterestEvent.USER_TALK:
			...
			if(m_client.getGameState() == 1) {
				m_client.checkWord(ie.getTalk());
			}
			break;
		default:
			return;
